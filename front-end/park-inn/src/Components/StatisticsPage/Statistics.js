...
import { lotUtilizationChart, dailySalesChart, monthlySalesChart, peakHoursChart } from "./../ChartData/Charts";
                ...
                <GridItem xs={12} sm={6} md={3}>
                    <Card>
                        <CardHeader color="lightTeal" icon>
                            ...
                            <p id="icon-text">
                                <font color="#74c9d4"><b>20 minute(s)</b></font>
                            </p>
                            <Divider />
                            hi
                        </CardHeader>
                ...
                <GridItem xs={12} sm={6} md={3}>
                    <Card>
                        <CardHeader color="red" icon>
                            ...
                            <p id="icon-text">
                                <font color="#E57373"><b>10 users</b></font> parked
                            </p>
                            <Divider />
                            <NavLink className="link" to='/parking'>
                                <p id="link">
                                    <img src={ArrowIcon} height="12px" width="12 px" alt="press-link" /> View Lot Utilization
                                </p>
                            </NavLink>
                        </CardHeader>
                    </Card>
                ...
                <GridItem xs={12} sm={6} md={3}>
                    <Card>
                        <CardHeader color="green" icon>
                            ...
                            <p id="icon-text">
                                <font color="#81C784"><b>$1,000</b></font> earned today
                            </p>
                            <Divider />
                            <NavLink className="link" to='/parking'>
                                <p id="link">
                                    <img src={ArrowIcon} height="12px" width="12 px" alt="press-link" /> View Sold Spots
                                </p>
                            </NavLink>
                        </CardHeader>
                    </Card>
                    ...
                    <Card style={{ height: "9rem" }}>
                        <CardBody>
                            <CardHeader color="darkBlue">
                                <h2 id="card-title"><center>Total Revenue</center></h2>
                            </CardHeader>
                            <br />
                            <Divider />
                            <h2 id="card-text"><center>$200,000</center></h2>
                        </CardBody>
                    </Card>
                </GridItem>
                ...
                <GridItem xs={12} sm={6} md={4}>
                    <Card>
                        ...
                        <CardBody>
                            <Divider />
                            <br />
                            <font color="#90CAF9" id="card-text">This Week's Sales Trend</font>
                        </CardBody>
                    </Card>
                </GridItem>
                ...
                <GridItem xs={12} sm={6} md={4}>
                    <Card>
                        ...
                        <CardBody>
                            <Divider />
                            <br />
                            <font color="#4ea3cc" id="card-text">Monthly Revenue Earned</font>
                        </CardBody>
                    </Card>
                </GridItem>
                ...
                <GridItem xs={12} sm={6} md={4}>
                    <Card>
                        ...
                        <CardBody>
                            <Divider />
                            <br />
                            <font color="#1B262C" id="card-text">Peak Hours</font>
                        </CardBody>
                    </Card>
                </GridItem>
            </GridContainer>
